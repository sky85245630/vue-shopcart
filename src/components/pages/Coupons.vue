...
export default {
  ...
  methods: {
    ...
    getCoupons() {
      const vm = this;
      const url = `https://vue-course-api.herokuapp.com/api/louie/admin/coupons`;
    ...
    updateCoupon() {
      const vm = this;
      if (vm.isNew) {
        const url = `https://vue-course-api.herokuapp.com/api/louie/admin/coupon`;
        ...
        const url = `https://vue-course-api.herokuapp.com//api/louie/admin/coupon/${vm.tempCoupon.id}`;
